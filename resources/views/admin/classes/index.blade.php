    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
       ...
       <div class="sidebar pe-4 pb-3">
        ...
        <div class="content">
            ...
            <!-- Navbar End --><div class="container">
        ...
        <tbody>
            @foreach($classes as $classe)
                <tr>
                    ...
                    <td>{{ $classe->nom }}</td>
                    <td>{{ $classe->code }}</td>
                    <td>{{ $classe->max_enseignants }}</td>
                    <td>
                        <a href="{{ route('admin.classes.show', $classe->id) }}" class="btn btn-dark btn-sm">Voir</a>
                        <a href="{{ route('admin.classes.edit', $classe->id) }}" class="btn btn-info btn-sm">Modifier</a>

                        <!-- Supprimer via modal Bootstrap -->
        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $classe->id }}">
            Supprimer
        </button>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-danger" id="deleteModalLabel{{ $classe->id }}">
                            Confirmation de suppression
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <p>Voulez-vous vraiment supprimer la classe <strong>{{ $classe->titre }}</strong> ?</p>
