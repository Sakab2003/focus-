                ...
                <div class="col-12">
                    <div class="bg-light rounded p-4">
                        ...
                        <h4 class="mb-4 text-primary">
                            <i class="fa fa-eye me-2"></i>Détails de la matiere
                        </h4>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <p>{{ $matiere->school_year }}</p>
                            </div>

                            <div class="col-md-6">
                                <strong>Code de la matiere :</strong>
                                <p>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <p>{{ $matiere->created_at->format('d/m/Y à H:i') }}</p>
                            </div>

                        {{-- STATISTIQUES (visuel) --}}
                        <div class="alert alert-secondary">
                            <strong>Aperçu :</strong><br>
                            Enseignants : 0 / 100<br>
                            Parents : 0<br>
                            Élèves : 0<br>
                            Matières : 0
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <a href="{{ route('admin.matieres.edit', $matiere->id) }}" class="btn btn-warning">
