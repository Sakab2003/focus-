...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <!-- Enseignant options -->
                    <a href="/admin/ajout_classe" class="nav-item nav-link"><i
                            class="fa fa-plus me-2"></i>Créer classes virtuelles</a>
                    <a href="/admin/ajout_matiere" class="nav-item nav-link"><i
                            class="fa fa-plus me-2"></i>Ajout de matieres</a>
                    <a href="/admin/liste_classe" class="nav-item nav-link"><i
                            class="fa fa-th me-2"></i>Mes classes</a>
                    ...
                    <a href="#" class="nav-item nav-link"><i
                            class="fa fa-users me-2"></i>Gérer les élèves</a>
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
            <h1 class="text-center">Creation de matieres</h1>
     <br>
    ...
    <form action="/ajout_classe/traitement" method="POST">
      @csrf
<br>
<div class="mb-3">
    <label for="matieres" class="form-label"><strong>Choisissez les matières que vous enseignez :</strong></label>
    <div id="matieres">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="matieres[]" value="Calcul" id="calcul">
            <label class="form-check-label" for="calcul">Calcul</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="matieres[]" value="Mathematique" id="mathematique">
            <label class="form-check-label" for="mathematique">Mathématique</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="matieres[]" value="Histoire" id="histoire">
            <label class="form-check-label" for="histoire">Histoire</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="matieres[]" value="Geographie" id="geographie">
            <label class="form-check-label" for="geographie">Géographie</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="matieres[]" value="Art" id="art">
            <label class="form-check-label" for="art">Art</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="matieres[]" value="Musique" id="musique">
            <label class="form-check-label" for="musique">Musique</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="matieres[]" value="Anglais" id="anglais">
            <label class="form-check-label" for="anglais">Anglais</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="matieres[]" value="Francais" id="francais">
            <label class="form-check-label" for="francais">Français</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="matieres[]" value="Espagnol" id="espagnol">
            <label class="form-check-label" for="espagnol">Espagnol</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="matieres[]" value="Education civique" id="education_civique">
            <label class="form-check-label" for="education_civique">Éducation civique</label>
        </div>
    </div>
</div>

        <button type="submit" class="btn btn-primary">Creer la classe</button><br><br>
        <a href="/admin/dashboard" class="btn btn-danger">Retour sur la liste</a>
    </form>
