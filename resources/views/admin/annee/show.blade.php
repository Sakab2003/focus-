        ...
        <div class="col-12">
            <div class="bg-light rounded p-4">
                ...
                <h4 class="mb-4 text-primary">
                    <i class="fa fa-eye me-2"></i>Détails de l'année scolaire
                </h4>

                <div class="row mb-3">
                    <div class="col-md-6">
                        <strong>Nom de l'année :</strong>
                        <p>{{ $annee->libelle ?? '-' }}</p>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <p>{{ $annee->date_debut ? \Carbon\Carbon::parse($annee->date_debut)->format('d/m/Y') : '-' }}</p>
                    </div>

                    <div class="col-md-6">
                        <strong>Date de fin :</strong>
                        <p>{{ $annee->date_fin ? \Carbon\Carbon::parse($annee->date_fin)->format('d/m/Y') : '-' }}</p>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <p>{{ $annee->created_at ? $annee->created_at->format('d/m/Y à H:i') : '-' }}</p>
                    </div>

                    <div class="col-md-6">
                        <strong>Statut :</strong>
                        <p>
                            <span class="badge {{ $annee->is_active ? 'bg-success' : 'bg-secondary' }}">
                                {{ $annee->is_active ? 'Active' : 'Inactive' }}
                            </span>
                        </p>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('admin.annee.index') }}" class="btn btn-secondary">
                        <i class="fa fa-arrow-left me-1"></i> Retour à la liste
                    </a>

                    <a href="{{ route('admin.annee.edit', $annee->id) }}" class="btn btn-warning">
