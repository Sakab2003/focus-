...
<body>
    ...
    <a href="{{ route('admin.annee.create') }}" class="btn btn-primary mb-3">Nouvelle année</a>
    ...
    <tr>
        ...
        <td>
            <a href="{{ route('admin.annee.show', $annee->id) }}" class="btn btn-info btn-sm">Voir</a>
            <a href="{{ route('admin.annee.edit', $annee->id) }}" class="btn btn-warning btn-sm">Editer</a>
             <!-- Supprimer via modal Bootstrap -->
        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $annee->id }}">
            Supprimer
        </button>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-danger" id="deleteModalLabel{{ $annee->id }}">
                            Confirmation de suppression
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <p>Voulez-vous vraiment supprimer l'annee <strong>{{ $annee->titre }}</strong> ?</p>
