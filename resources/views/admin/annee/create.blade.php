...
<head><link rel="stylesheet" href="{{ asset('assets/bootstrap/css/bootstrap.min.css') }}">
    <meta charset="utf-8">
...
<body>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="libelle" class="form-control" placeholder="2025-2026" required pattern="\d{4}-\d{4}" value="{{ old('libelle') }}">
    </div>
    ...
    <button type="submit" class="btn btn-primary">Ajouter l'année scolaire</button>
