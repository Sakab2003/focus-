...
<link rel="stylesheet" href="{{ asset('assets/fontawesome/css/all.min.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/bootstrap-icons/bootstrap-icons.css') }}">    <meta charset="utf-8">
       ...
       <div class="sidebar pe-4 pb-3">
        ...
        <div class="content">
            ...
            <form action="{{ route('admin.annee.update', $annee->id) }}" method="POST">
                ...
                <div class="mb-3">
                    <label class="form-label">Libellé (ex: 2025-2026)</label>
                    <input type="text" name="libelle" class="form-control @error('libelle') is-invalid @enderror"
                           value="{{ old('libelle', $annee->libelle) }}" placeholder="2025-2026" required pattern="\d{4}-\d{4}">
                    @error('libelle')
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="date_debut" class="form-control @error('date_debut') is-invalid @enderror"
                           value="{{ old('date_debut', $annee->date_debut) }}" required>
                    @error('date_debut')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="date_fin" class="form-control @error('date_fin') is-invalid @enderror"
                           value="{{ old('date_fin', $annee->date_fin) }}" required>
                    @error('date_fin')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <a href="{{ route('admin.annee.index') }}" class="btn btn-secondary">Annuler</a>
            </form>
        </div>
