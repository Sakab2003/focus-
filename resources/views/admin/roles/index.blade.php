...
<body>
    ...
    <a href="{{ route('admin.roles.create') }}" class="btn btn-primary mb-3">Ajouter un utilisateur</a>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $user->prenom }}</td>
                <td>{{ $user->email }}</td>
                <td>{{ $user->roleRelation?->Nom ?? $user->role }}</td>
                <td>
                    <a href="{{ route('admin.roles.show', $user->id) }}" class="btn btn-info btn-sm">Voir</a>
                    <a href="{{ route('admin.roles.edit', $user->id) }}" class="btn btn-warning btn-sm">Modifier</a>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Voulez-vous vraiment supprimer cet utilisateur <strong>{{ $user->nom }}</strong> ?</p> 
