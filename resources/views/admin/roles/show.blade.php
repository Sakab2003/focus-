    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
       ...
       <div class="sidebar pe-4 pb-3">
        ...
        <div class="content">
            ...
            <!-- Navbar End --><div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded p-4">

                            <h4 class="mb-4 text-primary">
                                <i class="fa fa-eye me-2"></i>Détails de l'utilisateur
                            </h4>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <strong>Rôle :</strong>
                                    <p>{{ $user->roleRelation?->Nom ?? $user->role }}</p>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <a href="{{ route('admin.roles.edit', $user->id) }}" class="btn btn-warning">
