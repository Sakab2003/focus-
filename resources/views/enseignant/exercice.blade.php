...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/bootstrap-icons/bootstrap-icons.css') }}">
    <title>DASHMIN - Ajouter un Exercice</title>
...
<div class="container-xxl position-relative bg-white d-flex p-0">
  ...
  <h1 class="text-center mb-4">Ajout d'un exercice</h1>
                    ...
                    <form action="/exercice/traitement" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- Titre --}}
                        <div class="mb-3">
                            <label for="titre" class="form-label">Titre de l'exercice <span class="text-danger">*</span></label>
                        ...
                        {{-- Contenu --}}
                        <div class="mb-3">
                            <label for="contenu" class="form-label">Contenu de l'exercice <small class="text-muted">(texte riche, optionnel)</small></label>
                        ...
                        {{-- Autres fichiers --}}
                        <div class="mb-3">
                            <label for="fichiers" class="form-label">Autres fichiers (optionnel, plusieurs possibles)</label>
...
document.getElementById('niveau').addEventListener('change', function () {
    ...
    fetch(`/enseignant/classes-par-niveau/${niveau}`)
        ...
        .then(classes => {
            if (classes.length === 0) {
                container.innerHTML = "<p class='alert alert-warning'>Aucune classe pour ce niveau.</p>";
                return;
            }
            ...
            classes.forEach(cl => {
                html += `
                <div class="col-md-4">
                    <div class="card p-3 shadow-sm class-card" data-id="${cl.id_classe}" style="cursor:pointer">
                        <h5>${cl.niveau}</h5>
            ...
            document.querySelectorAll('.class-card').forEach(card => {
                card.addEventListener('click', function () {
                    document.querySelectorAll('.class-card').forEach(c => c.classList.remove('border','border-primary'));
