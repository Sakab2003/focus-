     ...
     src="{{ Auth::user()->enseignant && Auth::user()->enseignant->photo
        ...
        : asset('admin/img/user.jpg') }}">
            ...
            <div class="container text-center">
                <a href="/enseignant/profile" class="btn btn-primary">Voir mon profile</a>
            </div>
            <br>
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="/enseignant/dashboard" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Mon tableau de bord</a>
                    <a href="/enseignant/ajout_classe" class="dropdown-item"><h2>Creer classes <br> virtuelles</h2></a>
                    <div><a href="/enseignant/liste_classe" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Mes classes</a></div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Cours et Execices</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="/enseignant/ajoutcours" class="dropdown-item">Ajout de cours</a>
                            <a href="/enseignant/exercice" class="dropdown-item">Ajout d'exercices</a>
                        </div>
                    </div>
                    <a href="/enseignant/listecours" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Mes cours</a>
                    <a href="/enseignant/listeexercice" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Mes exercices</a>
                    <a href="/enseignant/gestion_eleve" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Gerer les eleves</a>
                    <div class="nav-item dropdown">
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-chart-line fa-3x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Classes virtuelles</p>
