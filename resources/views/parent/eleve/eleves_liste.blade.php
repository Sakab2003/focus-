...
<div class="nav-item dropdown">                    <a href="/parent/eleve/liste" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Devoirs</a>
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
            <h2 class="mb-4">
    📘 {{ $devoir->cours->titre ?? 'Traitement du Devoir' }}
</h2>

<div class="card p-4 shadow-sm">
    <form action="{{ route('parent.traiter_devoir_eleve') }}" method="GET">
        @csrf
        <input type="hidden" name="devoir_id" value="{{ $devoir->id }}">

        <div class="mb-3">
            <label class="form-label fw-bold">👨‍🎓 Choisir l'élève qui va composer</label>
            ...
            @else
                <div class="alert alert-warning">
                    ⚠️ Aucun de vos enfants n'est enregistré dans cette classe (ID: {{ $classeId }}).
                    <br>Veuillez vérifier vos inscriptions.
                </div>
            @endif
        </div>

        <button type="submit" class="btn btn-success" @if($eleves->isEmpty()) disabled @endif>
            ✅ Valider le choix
        </button>
    </form>
</div><br>
