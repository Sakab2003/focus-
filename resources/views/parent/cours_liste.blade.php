...
<div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/parent/eleve/inscription" class="dropdown-item" class="fa fa-keyboard me-2"><h1>Inscriptions</h1></a>

                    <div class="nav-item dropdown">
                        <a href="{{ route('parent.cours') }}" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Cours</a>
                    ...
                    <a href="/parent/eleve/enseignant" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Choix d'enseignant</a>
        ...
        <div class="content">
            ...
            <h2>Cours pour : {{ $classe->niveau }} {{ $classe->nom }}</h2>
...
<div class="card p-3 mb-3">
    ...
    @if($c->fichier)
        <a href="{{ asset('storage/'.$c->fichier) }}" download class="btn btn-primary">
