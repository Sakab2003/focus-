                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Total des cours disponibles</p>
                                <h6 class="mb-0">{{ $total_cours }}</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0">{{ $total_enseignants }}</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Total des eleves inscrits</p>
                                <h6 class="mb-0">{{ $total_eleves }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
...
<td>
    <a href="{{ route('coursgenerales.show_parent', $c->id) }}" class="btn btn-info btn-sm">
        Consulter
    </a>
</td>
</tr>
